...
<div class="flex h-screen z-10">
	<div
		id="Sidebar"
		class="sidebar absolute flex flex-col bg-sidebar-dark-primary backdrop-blur-ms border border-emerald-200 rounded-xl top-4 left-4 w-48 z-10"
	>
		<div
			id="Content"
		...
		<div
			id="Footer"
			class="relative flex flex-col space-y-2 bg-transparent p-4 h-1/6 rounded-xl list-none text-center text-sidebar-light-secondary shadow-md"
		>
			...
			<li class="hover:text-sidebar-light-primary">
				<form method="post" action="/logout">
					<button type="submit" class="hover:text-sidebar-light-primary">Sign Out</button>
				</form>
			</li>

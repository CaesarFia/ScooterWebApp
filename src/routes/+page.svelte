      ...
      <div id="LoginPopUp" class="absolute flex  flex-col items-center justify-center bg-sidebar-dark-primary border border-emerald-200 rounded-xl w-96 transition:fly={{y:-500}}">
        ...
        <form method="POST" action="?/signin">
          ...
          <div class="relative flex items-center mt-4">
            ...
            <input type="password" name="password" bind:value={password} class="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-emerald-300 dark:focus:border-blue-300 focus:ring-emerald-200 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Password" required>
          </div>
          <div class="mt-6">
            <button name="signinButton" class="w-full px-6 py-3 text-sm font-medium tracking-wide shadow-md text-white capitalize transition-colors duration-300 transform bg-emerald-400 rounded-lg hover:bg-emerald-200 focus:outline-none focus:ring focus:ring-emerald-200 focus:ring-opacity-50">
              Sign In
            </button>
          </div>
        </form>
        ...
        <form method="POST" action="?/signup">
          ...
          <div class="relative flex items-center mt-4">
            ...
            <input type="password" bind:value={confirmPassword} name="confirmPassword" class="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-emerald-300 dark:focus:border-blue-300 focus:ring-emerald-200 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Confirm Password">
          </div>
          <div class="mt-6">
            <button name="signupButton" class="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-emerald-400 rounded-lg hover:bg-emerald-200 focus:outline-none focus:ring focus:ring-blue-300  focus:ring-opacity-50">
              Sign Up
            </button>
          </div>
        </form>
